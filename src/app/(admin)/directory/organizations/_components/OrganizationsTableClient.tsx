...
import { Building2, Search, SlidersHorizontal, ArrowUpDown } from "lucide-react";
...
export function OrganizationsTableClient({ initialOrgs }: { initialOrgs: Org[] }) {
              ...
              <tr>
                <td colSpan={5} className="px-6 py-12">
                  <EmptyState 
                    ...
                    description={search ? `We couldn't find any organizations matching "${search}".` : "There are no organizations yet."}
                  />
                </td>
              </tr>
            )}

  ...
  return (
    <div className="max-w-6xl mx-auto h-full flex flex-col">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">Proposals</h2>
          <p className="text-sm text-gray-500 mt-1">Manage Statements of Work and Client Agreements.</p>
        </div>
      </div>

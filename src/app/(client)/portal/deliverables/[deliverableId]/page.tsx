        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Latest Version</h3>
                ...
                <div>
                  <div className="flex justify-between items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="flex items-center">
                      <FileIcon className="w-8 h-8 text-indigo-500 mr-4" />
                      <div>
                        <h4 className="text-gray-900 font-medium">{latestVersion.fileName}</h4>
                    ...
                    <a href={latestVersion.fileUrl} target="_blank" rel="noreferrer" className="text-indigo-600 text-sm font-medium hover:underline">
                      Download &rarr;
                    </a>
                  </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 h-fit shadow-sm">
            <h3 className="text-lg font-bold text-gray-900 mb-6 flex items-center">
              <MessageSquareIcon className="w-5 h-5 mr-2 text-indigo-500" />
              Feedback History
            </h3>
                ...
                visibleComments.map(c => (
                  <div key={c.id} className="text-sm">
                    <div className="flex justify-between items-start mb-1">
                      <span className="font-semibold text-gray-900">{c.userFirstName || c.userEmail}</span>

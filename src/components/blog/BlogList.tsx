    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-16 justify-center">
        <button 
          ...
          className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${activeCategory === "All Articles" ? "bg-slate-900 text-white" : "bg-white border border-slate-200 text-slate-700 hover:border-primary hover:text-primary"}`}
        >
          All Articles
        </button>
